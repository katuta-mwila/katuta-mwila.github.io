...
export default function Projects(){
  return <VertBox tag='section' id='Projects' className="flex flex-col items-center" gap='20px'>
    ...
    <div className="content-box content-width projects-box">
      ...
      <VertBox gap='20px'>
        <div className="font-bold text-[50px]">Performance Logger</div>
        <div className='proj-con'>
          <VertBox className="proj-left" gap='20px'>
            ...
            <VertBox className="proj-sec" gap='10px'>
              ...
              <p>The demo is a version of the website that contains randomly generated datapoints and gives a good idea for what the website is useful for.</p>
              <ul className="list-disc list-inside">
      ...
      <VertBox gap='20px'>
        <div className="font-bold text-[50px]">Games Center</div>
        <div className='proj-con'>
          <VertBox className="proj-left" gap='20px'>
            <VertBox className="proj-sec" gap='20px'>
      ...
      <VertBox gap='20px'>
        <div className="font-bold text-[50px]">Flag Guesser</div>
        <div className='proj-con'>
          <VertBox className="proj-left" gap='20px'>
            <p>Flag guesser is a small group project I contributed to during my time in bootcamp at Dev Academy NZ.</p>
            ...
            <VertBox className="proj-sec" gap='10px'>
              <h3 className="font-bold">Development</h3>
              <p>Flag Guesser was built using the following tech.</p>
              <Box className="skills-tiles" gap='10px'>
                <SkillTile icon={faCss} text="CSS"/>
                <SkillTile icon={faJs} text="JavaScript"/>
                <SkillTile icon={'/images/typescript-svgrepo-com.svg'} text='TypeScript'/>
